...
export function NavigationBar() {
  ...
  const currentPage = location.pathname.includes('upload')
    ...
    : location.pathname.includes('statements')
      ? 'statements'
      : location.pathname.includes('trip-summary')
        ? 'trip-summary'
        : null;
    ...
    <div className="flex items-center justify-between gap-1">
      ...
      {session ? (
        ...
        <div className="flex items-center gap-1">
          ...
          <Button variant="default" size="sm" className="h-8 px-2 text-xs" onClick={() => navigate('/signup')}>
            Sign Up
          </Button>
        </div>
      )}
    ...
    <div className="flex items-center justify-between gap-4">
      <div className="flex items-center gap-2 md:gap-8">
        ...
        <div className="flex items-center gap-1 md:gap-2">
          ...
          <Button
            variant={currentPage === 'trip-summary' ? 'default' : 'ghost'}
            size="sm"
      ...
      {session ? (
        ...
        <div className="flex items-center gap-2">
          <Button variant="ghost" size="sm" className="px-3 text-sm" onClick={() => navigate('/login')}>
            Log In
          </Button>
